...
const exp = [
  {
    ...
    company: "Qualys Security Techservices Pvt Ltd",
    date: "April 2024 - Present",
    desc: "I played a key role in designing and developing innovative solutions and applications for the company, including ROC (Risk Operation Center) and ETM (Enterprise TruRisk Management). My responsibilities also included creating new custom components for RX, Qualys’s proprietary UI Components Library. Additionally, I contributed to transforming the existing Qualys application into a Progressive Web Application (PWA) to enhance its functionality and user experience.",
  },
  {
    id: "2",
